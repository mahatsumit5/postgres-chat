...
ADD COLUMN     "fromUser" TEXT NOT NULL;

-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_fromUser_fkey" FOREIGN KEY ("fromUser") REFERENCES "User"("email") ON DELETE RESTRICT ON UPDATE CASCADE;
